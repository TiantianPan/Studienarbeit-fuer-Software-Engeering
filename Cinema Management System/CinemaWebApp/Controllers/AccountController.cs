...
namespace CinemaWebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
               // using (var context = new CinemaModelContainer())
                //{
                    if (db.Customers.Any(s => s.Email == model.Email))
                    {
                        AddErrors(
                            new IdentityResult(new string[]
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var admin = from Customer in db.Customers select Customer;
                        int adminNum = admin.Count();
                        //Die erste registrierte Person wird ein Approver, alle anderen nicht
                        CinamaLib1.Customer customer = new Customer();
                        ...
                        db.SaveChanges();
                        return RedirectToAction("Edit", "LoginUser");
                        //var person = new Person { Email = model.Email };
        ...
        // Nach Anmeldung direkt zu HomePage View()
